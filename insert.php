<?php
    ...
    $duplicate_username = mysqli_query($conn,"SELECT * FROM `web_final_data` WHERE username='$r_name'");
    ...
    if(mysqli_num_rows($duplicate_username)>0){
        ...
        $insertQuery = "INSERT INTO `web_final_data`(`username`, `pass`, `mobile`, `email`,`token`) VALUES ('$r_name','$r_pass','$r_mobile','$r_email','$token')";
