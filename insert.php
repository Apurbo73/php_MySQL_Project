<?php
    ...
    $duplicate_username = mysqli_query($conn,"SELECT * FROM `web-final` WHERE username='$r_name'");
    ...
    if(mysqli_num_rows($duplicate_username)>0){
        ...
        $insertQuery = "INSERT INTO `web-final`(`username`, `pass`, `mobile`, `email`) VALUES ('$r_name','$r_pass','$r_mobile','$r_email')";
